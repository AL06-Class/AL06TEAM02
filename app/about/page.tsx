...
const sections: DocumentSection[] = [
  {
    ...
    title: "서비스 소개",
    paragraphs: [
      "CLIPBee는 촬영·편집 의뢰자와 촬영자·촬영팀·편집자를 연결하는 데모 플랫폼입니다. 공고, 프로필, 스토어, 커뮤니티를 한곳에서 탐색할 수 있도록 설계했습니다.",
      "운영 주체 표기는 CLIPBee 주식회사(가칭)이며, 본 페이지의 회사 정보는 프로젝트 시연을 위한 가상 정보입니다.",
    ],
  },
  {
    id: "principle",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "가상 운영 정보: CLIPBee 주식회사(가칭), 서울시 내 가상 업무공간, support@clipbee.example.kr",
    ],
  },
];

export default function AboutPage() {
  return <DocumentPage title="회사소개" description="CLIPBee의 목적, 운영 원칙, 데모 범위를 안내합니다." sections={sections} />;
}
